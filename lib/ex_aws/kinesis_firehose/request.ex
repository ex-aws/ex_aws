defmodule ExAws.KinesisFirehose.Request do
  @moduledoc false
  # Kinesis Firehose specific request logic.

  @type response_t :: %{} | ExAws.Request.error_t

  def request(client, action, data) do
    {operation, http_method} = ExAws.KinesisFirehose.Impl |> ExAws.Actions.get(action)
    headers = [
